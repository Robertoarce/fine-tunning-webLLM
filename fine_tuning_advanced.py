...
class RobertoFineTuner:
    """Advanced fine-tuning class for Roberto Arce model"""
    ...
    def setup_model_and_tokenizer(self):
        ...
        if lora_config.get('enabled', False):
            ...
            self.logger.info(
                f"LoRA applied! Trainable parameters: {self.model.num_parameters()}")
        else:
            self.logger.info(
    ...
    def setup_training_args(self):
        ...
        if output_config['include_timestamp']:
            ...
            output_dir = f"{output_config['base_dir']}_{timestamp}"
        else:
    ...
    def train(self):
        ...
        # Save LoRA adapters separately if LoRA is enabled
    ...
    def test_model(self, prompt="Roberto Arce is a"):
        ...
        self.logger.info("Testing the fine-tuned model...")
