...
Answer:"""
    ...
    def generate_answer(
        ...
        # Use greedy decoding (do_sample=False) when temperature is 0
    ...
    def interactive_mode(self):
        ...
        while True:
            try:
                ...
                if not documents:
                    print(
                        "No documents provided. Please provide at least one document.\n")
                    continue
...
def main():
    ...
    if len(sys.argv) > 1:
        ...
        if not model_path:
            logger.error(
                "No RAFT model found. Please train a model first or specify path.")
